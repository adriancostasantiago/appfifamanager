...
class _SellPlayerPageState extends State<SellPlayerPage> {
  ...
  Color _valuePctColor(BuildContext context) {
    if (_valuePct >= 1.0) return context.colors.green;
    if (_valuePct >= 0.8) return context.colors.orange;
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(color: context.colors.green, width: 1),
              ),
              content: Row(
                children: [
                  Icon(Icons.check_circle_outline, color: context.colors.green),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _TransferValueCard(
                      ...
                      pct: _valuePct,
                      pctColor: _valuePctColor(context),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: context.colors.green.withValues(alpha: 0.04),
            blurRadius: 24,
            spreadRadius: 2,
          ),
        ],
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    //         color: i.isEven
                    //             ? context.colors.green.withValues(alpha: 0.5)
                    //             : Colors.transparent,
                    //       ),
                    //     ),
                    //   ),
...
//   const TransferAnimation({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected
              ? context.colors.green.withValues(alpha: 0.08)
              : context.colors.cardAlt,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: selected
        ...
        child: Column(
          children: [
            Icon(
              icon,
              size: 24,
              color: selected ? context.colors.green : context.colors.subtle,
            ),
            const SizedBox(height: 6),
            Text(
              label,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.sell_outlined, color: context.colors.onAccent, size: 22),
            SizedBox(width: 12),
            Text(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(icon, color: context.colors.green, size: 14),
